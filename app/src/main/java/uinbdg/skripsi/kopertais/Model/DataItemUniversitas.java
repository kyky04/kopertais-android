...
public class DataItemUniversitas implements Parcelable {
	...
	public DataItemUniversitas() {
	}

	protected DataItemUniversitas(Parcel in) {
	...
	public static final Parcelable.Creator<DataItemUniversitas> CREATOR = new Parcelable.Creator<DataItemUniversitas>() {
		@Override
		public DataItemUniversitas createFromParcel(Parcel source) {
			return new DataItemUniversitas(source);
		}

		@Override
		public DataItemUniversitas[] newArray(int size) {
			return new DataItemUniversitas[size];
		}
	};
}